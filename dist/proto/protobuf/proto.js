...
$root.lanlu = (function() {
    ...
    lanlu.Pt100_1_tos = (function() {
        ...
        Pt100_1_tos.prototype.userName = "";
        Pt100_1_tos.prototype.passWord = "";
        ...
        Pt100_1_tos.fromObject = function fromObject(object) {
            if (object instanceof $root.lanlu.Pt100_1_tos)
                return object;
            var message = new $root.lanlu.Pt100_1_tos();
        ...
        Pt100_1_tos.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
    ...
    lanlu.Pt100_1_toc = (function() {
        ...
        Pt100_1_toc.prototype.serverTime = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        Pt100_1_toc.prototype.code = 0;
        Pt100_1_toc.prototype.roleList = $util.emptyArray;
        ...
        Pt100_1_toc.encode = function encode(message, writer) {
            ...
            if (message.roleList != null && message.roleList.length)
                for (var i = 0; i < message.roleList.length; ++i)
                    writer.uint32(32).uint32(message.roleList[i]);
            return writer;
        };
                ...
                case 4:
                    ...
                    if ((tag & 7) === 2) {
                        ...
                        while (reader.pos < end2)
                            message.roleList.push(reader.uint32());
                    } else
                        message.roleList.push(reader.uint32());
                    break;
                default:
        ...
        Pt100_1_toc.fromObject = function fromObject(object) {
            ...
            if (object.roleList) {
                if (!Array.isArray(object.roleList))
                    throw TypeError(".lanlu.Pt100_1_toc.roleList: array expected");
                message.roleList = [];
                for (var i = 0; i < object.roleList.length; ++i)
                    message.roleList[i] = object.roleList[i] >>> 0;
            }
            return message;
        };
        ...
        Pt100_1_toc.toObject = function toObject(message, options) {
            ...
            if (message.roleList && message.roleList.length) {
                ...
                for (var j = 0; j < message.roleList.length; ++j)
                    object.roleList[j] = message.roleList[j];
            }
            return object;
        };
    ...
    lanlu.Pt100_2_tos = (function() {

        function Pt100_2_tos(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        Pt100_2_tos.create = function create(properties) {
            return new Pt100_2_tos(properties);
        };

        Pt100_2_tos.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            return writer;
        };

        Pt100_2_tos.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        Pt100_2_tos.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lanlu.Pt100_2_tos();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        Pt100_2_tos.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        Pt100_2_tos.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            return null;
        };

        Pt100_2_tos.fromObject = function fromObject(object) {
            if (object instanceof $root.lanlu.Pt100_2_tos)
                return object;
            return new $root.lanlu.Pt100_2_tos();
        };

        Pt100_2_tos.toObject = function toObject() {
            return {};
        };

        Pt100_2_tos.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    lanlu.Pt100_2_toc = (function() {

        function Pt100_2_toc(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        Pt100_2_toc.create = function create(properties) {
            return new Pt100_2_toc(properties);
        };

        Pt100_2_toc.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            return writer;
        };

        Pt100_2_toc.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        Pt100_2_toc.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lanlu.Pt100_2_toc();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        Pt100_2_toc.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        Pt100_2_toc.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            return null;
        };

        Pt100_2_toc.fromObject = function fromObject(object) {
            if (object instanceof $root.lanlu.Pt100_2_toc)
                return object;
            return new $root.lanlu.Pt100_2_toc();
        };

        Pt100_2_toc.toObject = function toObject() {
            return {};
        };

        Pt100_2_toc.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    lanlu.Pt100_3_tos = (function() {

        function Pt100_3_tos(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        Pt100_3_tos.prototype.roleId = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        Pt100_3_tos.prototype.time = 0;
        Pt100_3_tos.prototype.ticket = "";
        Pt100_3_tos.prototype.os = "";
        Pt100_3_tos.prototype.mobile = "";
        Pt100_3_tos.prototype.mobiletype = "";
        Pt100_3_tos.prototype.fcm = 0;

        Pt100_3_tos.create = function create(properties) {
            return new Pt100_3_tos(properties);
        };

        Pt100_3_tos.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            writer.uint32(50).string(message.mobiletype);
            writer.uint32(56).uint32(message.fcm);
            return writer;
        };

        Pt100_3_tos.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        Pt100_3_tos.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lanlu.Pt100_3_tos();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Pt100_3_tos.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        Pt100_3_tos.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        Pt100_3_tos.fromObject = function fromObject(object) {
            if (object instanceof $root.lanlu.Pt100_3_tos)
                return object;
            var message = new $root.lanlu.Pt100_3_tos();
        ...
        Pt100_3_tos.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        Pt100_3_tos.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    lanlu.Pt100_3_toc = (function() {

        function Pt100_3_toc(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        Pt100_3_toc.prototype.code = 0;

        Pt100_3_toc.create = function create(properties) {
            return new Pt100_3_toc(properties);
        };

        Pt100_3_toc.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        Pt100_3_toc.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        Pt100_3_toc.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lanlu.Pt100_3_toc();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Pt100_3_toc.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        Pt100_3_toc.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!$util.isInteger(message.code))
                return "code: integer expected";
        ...
        Pt100_3_toc.fromObject = function fromObject(object) {
            if (object instanceof $root.lanlu.Pt100_3_toc)
                return object;
            var message = new $root.lanlu.Pt100_3_toc();
            if (object.code != null)
                message.code = object.code >>> 0;
            return message;
        };

        Pt100_3_toc.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        Pt100_3_toc.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
