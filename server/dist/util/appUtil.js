...
const routerServer_1 = require("../components/routerServer");
...
function startServer(app) {
    ...
    if (app.serverType === "master") {
        ...
        rpcService.init(app);
        app.routerServer = new routerServer_1.RouterServer(app);
...
let loadBaseConfig = function (app) {
    let configData = fs.readFileSync(CONFIG_ZONE_PATH, "utf-8");
...
function serverInfos2serverConfig(app) {
    let serverConfigs = {};
