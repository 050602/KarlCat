...
class DataBase extends Sigleton_1.Sigleton {
    ...
    async init() {
        ...
        return new Promise((resolve, reject) => {
            ...
            //    console.log(a);
            // });
            mongoose_1.default.connect(app_1.app.zoneConfig.mongodb_connectstring, options).then(async (db) => {
                console.log(app_1.app.serverType, app_1.app.serverName, "连接数据库成功");
                try {
